  ...
  useEffect(() => {
    ...
    sections.forEach((section, index) => {
      ...
      const prevBgColor =
        index === 0
          ? "#ffffff"
          : sections[index - 1].getAttribute("data-bgcolor");
    ...
    <div>
      ...
      <div className="main flex justify-center" data-bgcolor="#ffffff">
        <div className="absolute z-10 lg:mt-80 mt-28 text-center">
          <h1 className="font-unbounded font-bold text-3xl  lg:text-7xl">
            Team Groven
          </h1>
      ...
      <section className="text-gray-600 body-font main" data-bgcolor="#7E60BF">
        <div className="container px-5 py-24 mx-auto">
          <svg
            ...
            fill="currentColor"
            className="inline-block w-8 h-8 text-white mb-8 text-center ml-10"
          ...
          <div className=" w-full mx-auto text-left">
            <p className="leading-relaxed lg:text-4xl text-2xl text-black font-unbounded font-bold">
              At <span className=" font-extrabold text-white">Groven</span> we
              believe in cultivating innovative solutions that empower
              businesses to thrive in the digital age. Our mission is to
              transform the way companies operate by providing cutting-edge
              software products tailored to meet the unique needs of our
              clients.
            </p>
            <span className="inline-block h-1 w-10 rounded bg-white mt-8 mb-6"></span>
            <h2 className="text-gray-900 font-unbounded font-medium title-font tracking-wider text-sm">
              - Team Groven
            </h2>
          </div>
        </div>
